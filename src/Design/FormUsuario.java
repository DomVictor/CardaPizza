...
import conexaoBanco.BdCadastro;
...
public class FormUsuario extends JFrame {
	...
	final static String PP = "Painel Principal";
	...
	public FormUsuario() {
		...
		contentPane.add(PainelPrincipal_Usuario, PP);
		...
		scrollPane.setBounds(10, 101, 810, 582);
		PainelPrincipal_Usuario.add(scrollPane);
